...
\setlength{\floatsep}{0.1in} %  space left between floats.

\setlength{\textfloatsep}{.15in} %space between last top float or first bottom float and the text.

\setlength{\dblfloatsep}{.15in} %dbl: space between last top float or first bottom float and the text.

%%\setlength{\dbltextfloatsep}{.1in} %  dbl: space left between floats.

%%\setlength{\abovecaptionskip}{.1in}

%%\setlength{\belowcaptionskip}{.1in}

%%\setlength{\intextsep}{0.1in} % space left on top and bottom of an in-text float.
